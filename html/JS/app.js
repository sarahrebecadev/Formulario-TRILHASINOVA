...
function validarFormulario(event) {
  ...
  setTimeout(() => {
    // Oculta a tela de carregamento (corrigindo a referência)
    document.getElementById('carregando').style.display = 'none'; // Oculta a tela de carregamento

    // Redireciona para a página de sucesso ou confirmação
    window.location.href = "Pagina.html"; // Substitua "Pagina.html" pelo seu destino
  }, 1000); // Delay de 1 segundo para exibição do carregamento
}
